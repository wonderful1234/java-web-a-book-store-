...
<body>
 <div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="imges/00024.jpg" width="400" height="400" />
                        <img src="imges/00024.jpg" width="400" height="400" />
                        <img src="imges/00024.jpg" width="400" height="400" />
                        <img src="imges/00024.jpg" width="400" height="400" />
                        <img src="imges/00024.jpg" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		...
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="">41.2</a></span>
                        ...
                        <div class="extInfo">
            	            ...
            	            <div class="seller-pop-box">
            	            	...
            	            	<span class="tr">客家电话：17318702983</span>
            	            	<span class="tr hoh">
            	            ...
            	            <div class="suport-icons">
            	            	...
            	            	<img src="imges/00093.png" width="50%" height="50%"/>
            	            </div>
                        </div>
                    </div>                
<!-- 推荐搭配 -->                
                	...
                	<div class="dp_wrap">
                		...
                		<div class="dq_total_wrap">
                			...
                			<div class="dp_num">已经选择0个书籍
                				<p class="dq_price">总计<span>￥41.2</span>元</p>
                				<button class="get">立即购买</button>
                			</div>
                		</div>
                		<!-- 搭配1 -->
                		<div class="dq_ori">
                			<a class="dq_ori_prd" href="#"><img src="imges/00024.jpg"/></a>
                			<a class="ori_prd" href="#">人生海海</a>
                			<p class="ori_prd dp_wrap_pprice_ori">￥41.2</p>
                		</div>
                		<div class="scroll_wrap">
                			...
                			<div class="dp_prd">
                				...
                				<div class="dp_p_wrap">
                					<a class="dp_wrap_pimg" href="#" target="_blank"><img src="imges/00089.jpg"/></a>
                					<a class="dp_wrap_pname" href="#" target="_blank">风声</a>
                			...
                			<div class="dp_prd">
                				<div class="icon_plus">+</div>
                				<div class="dp_p_wrap">
                					<a class="dp_wrap_pimg" href="#" target="_blank"><img src="imges/00090.jpg"/></a>
                					<a class="dp_wrap_pname" href="#" target="_blank">解密</a>
                					<p class="dp_wrap_pprice">
                					<label>
                					<input type="checkbox" data-price="199" data-item="570b1b2f5efb114c378b4575">
                					￥21
                			...
                			<div class="dp_prd">
                				<div class="icon_plus">+</div>
                				<div class="dp_p_wrap">
                					<a class="dp_wrap_pimg" href="#" target="_blank"><img src="imges/00091.jpg"/></a>
                					<a class="dp_wrap_pname" href="#" target="_blank">暗算</a>
                					<p class="dp_wrap_pprice">
                					<label>
                					<input type="checkbox" data-price="199" data-item="570b1b2f5efb114c378b4575">
                					￥29.8
                		...
                		<div class="active_tab" id="outer">
												...
												<div id="content" class="active_list"> 
													...
													<div id="ui-a" class="ui-a">
												        ...
												        <li>商品编码：12508277</li>
												        <li>品牌：新经典</li>
												        <li>出版时间：2019-04-01</li>
												        <li>开本：32开</li>
												        <li>ISBN：9787530219218</li>
												        <li><img src="imges/00023.jpg"/></li>
												        </ul>
												   </div>
												   <!--商品规格-->
												    	<div id="bit" class="bit">
												        <ul style="display:none;">
												            <li><img src="imges/00028.PNG"/></li>
												            <li><img src="imges/00029.PNG"/></li>
												 ...
												 <div id="uic" class="uic">
												         <ul style="display:none;">
												         	...
												         	<p>品牌：新经典</p>
												         	<p>出版时间：2019-04-01</p>
												         	<span><img src="imges/00015.PNG"/></span>
