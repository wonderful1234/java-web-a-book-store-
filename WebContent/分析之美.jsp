...
<body>
 <div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="imges/00019.jpg" width="400" height="400" />
                        <img src="imges/00019.jpg" width="400" height="400" />
                        <img src="imges/00019.jpg" width="400" height="400" />
                        <img src="imges/00019.jpg" width="400" height="400" />
                        <img src="imges/00019.jpg" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		...
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="#">103.7</a></span>
                        ...
                        <div class="extInfo">
            	            ...
            	            <div class="suport-icons">
            	            	...
            	            	<img src="imges/00094.png" width="50%" height="50%"/>
            	            </div>
                        </div>
                    </div>                
<!-- 推荐搭配 -->                
                	...
                	<div class="dp_wrap">
                		...
                		<div class="dq_total_wrap">
                			...
                			<div class="dp_num">已经选择0个书籍
                				<p class="dq_price">总计<span>￥103.7</span>元</p>
                				<button class="get">立即购买</button>
                			</div>
                		</div>
                		<!-- 搭配1 -->
                		<div class="dq_ori">
                			<a class="dq_ori_prd" href="#"><img src="imges/00019.jpg"/></a>
                			<a class="ori_prd" href="#">分析之美</a>
                			<p class="ori_prd dp_wrap_pprice_ori">￥103.7</p>
                		</div>
                		<div class="scroll_wrap">
                			...
                			<div class="dp_prd">
                				<div class="icon_plus">+</div>
                				<div class="dp_p_wrap">
                					<a class="dp_wrap_pimg" href="#" target="_blank"><img src="imges/00088.jpg"/></a>
                					<a class="dp_wrap_pname" href="#" target="_blank">深度学习</a>
                					<p class="dp_wrap_pprice">
                					<label>
                					<input type="checkbox" data-price="199" data-item="570b1b2f5efb114c378b4575">
                					￥112.6
                		...
                		<div class="active_tab" id="outer">
												...
												<div id="content" class="active_list"> 
													...
													<div id="ui-a" class="ui-a">
												        ...
												        <li>商品编码：12405737</li>
												        <li>出版社： 人民邮电出版社</li>
												        <li>出版时间：2018-07-01</li>
												        <li>字数：1090000</li>
												        <li>ISBN：9787115485106</li>
												        <li><img src="imges/00020.jpg"/></li>
												        </ul>
												   </div>
												   <!--商品规格-->
												    	<div id="bit" class="bit">
												        <ul style="display:none;">
												            <li><img src="imges/00021.PNG"/></li>
												            <li><img src="imges/00022.PNG"/></li>
												       </ul>
												       </div>
