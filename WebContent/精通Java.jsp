...
<body>
 <div class="showall">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="imges/0001.jpg" width="400" height="400" />
                        <img src="imges/0002.jpg" width="400" height="400" />
                        <img src="imges/0001.jpg" width="400" height="400" />
                        <img src="imges/0002.jpg" width="400" height="400" />
                        <img src="imges/0001.jpg" width="400" height="400" />
                        <img src="imges/0001.jpg" width="400" height="400" />
                		...
                		<div class="active_tab" id="outer">
												...
												<div id="content" class="active_list"> 
													...
													<div id="ui-a" class="ui-a">
												        ...
												        <li>商品名称：Java从入门到精通(第5五版)</li>
												        <li>商品编码：12555860</li>
												        <li>品牌：清华大学出版社（TSINGHUA UNIVERSITY PRESS）</li>
												        <li>出版时间：2019-02-01</li>
												        <li>字数：1090000</li>
												        <li>ISBN：9787302517597</li>
												        <li><img src="imges/0009.jpg"/></li>
												        </ul>
												   </div>
												   <!--商品规格-->
												    	<div id="bit" class="bit">
												        <ul style="display:none;">
												            <li><img src="imges/00010.PNG"/></li>
												            <li><img src="imges/00011.PNG"/></li>
												            <li><img src="imges/00012.PNG"/></li>
